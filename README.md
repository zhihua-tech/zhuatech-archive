...
<p align="center"><img src="docs/images/product-overview.svg" alt="知华科技企业电子档案系统产品概览" width="920"></p>

## 从形成到销毁的可信档案链

档案的价值在于“找得到、信得过、用得上、销毁有依据”。本项目围绕这四件事组织功能。

ZhuaTech Archive 是知华科技（**上海如静知华信息科技有限公司**）维护的前后端分离企业应用社区源码版。产品、实施与技术服务信息请访问[知华科技官网](https://www.zhuatech.cn/)。
...
保管期限、法务冻结、未归还借阅、鉴定审批与完整性联合门禁。

- 接口：`POST /api/enterprise/archive/review-disposal`
...
- 预留 OA、合同系统、对象存储与电子签章 的适配器边界，不包含任何真实密钥
...
Java 工程包：`cn.zhuatech.archive`。前端默认端口：`8302`。
...
SEO：电子档案系统、档案管理、数字档案、档案借阅、档案销毁、知华科技、上海软件开发、企业信息化、软件项目外包。
